{{--
    Archivo: resources/views/admin/payments/edit.blade.php
    Roles: admin
    Rutas necesarias: Route::get('admin/payments/{payment}/edit', [PaymentController::class, 'edit'])
--}}

@extends('layouts.app')

@section('title', 'Editar Pago - Route Tracker')
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600">Modificar información del pago #{{ $payment->payment_id }}</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('admin.payments.show', $payment->payment_id) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
        ...
        <form action="{{ route('admin.payments.update', $payment->payment_id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="period_start" id="period_start" value="{{ old('period_start', $payment->period_start ? $payment->period_start->format('Y-m-d') : '') }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
                    @error('period_start')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="period_end" id="period_end" value="{{ old('period_end', $payment->period_end ? $payment->period_end->format('Y-m-d') : '') }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
                    @error('period_end')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input type="number" name="amount_total" id="amount_total" value="{{ old('amount_total', $payment->amount_total) }}" step="0.01" min="0" class="pl-7 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
                    </div>
                    @error('amount_total')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input type="number" name="platform_fee" id="platform_fee" value="{{ old('platform_fee', $payment->platform_fee) }}" step="0.01" min="0" class="pl-7 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
                    </div>
                    @error('platform_fee')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input type="number" name="provider_amount" id="provider_amount" value="{{ old('provider_amount', $payment->provider_amount) }}" step="0.01" min="0" class="pl-7 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
                    </div>
                ...
                <div>
                    ...
                    <select name="payment_status" id="payment_status" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
                        ...
                        <option value="processing" {{ old('payment_status', $payment->payment_status) == 'processing' ? 'selected' : '' }}>Procesando</option>
                        ...
                        <option value="cancelled" {{ old('payment_status', $payment->payment_status) == 'cancelled' ? 'selected' : '' }}>Cancelado</option>
            ...
            <div class="mt-8 flex justify-end space-x-3">
                <a href="{{ route('admin.payments.show', $payment->payment_id) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-md text-sm font-medium transition-colors">
                    Cancelar
                </a>
