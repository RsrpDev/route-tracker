...
@section('title', 'Mis Rutas - Conductor')
    ...
    <div class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Mis Rutas</h1>
                    <p class="text-gray-600">Gestiona las rutas asignadas para el transporte</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $routes->where('active_flag', false)->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $routes->sum(function($route) { return $route->transportContracts->where('contract_status', 'active')->count(); }) }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Lista de Rutas Asignadas</h3>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $route->school->school_name ?? 'N/A' }}</div>
                                    <div class="text-sm text-gray-500">{{ $route->school->address ?? 'N/A' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $route->transportContracts->where('contract_status', 'active')->count() }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('driver.routes.show', $route) }}" class="text-blue-600 hover:text-blue-900">
                                            Ver Detalles
                                        </a>
                                    </div>
                                </td>
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Contacta con tu supervisor para obtener asignaciones de rutas.</p>
                </div>
            @endif
        </div>
    </div>
