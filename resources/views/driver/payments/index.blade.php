        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600">Gestiona los pagos de tus servicios de transporte</p>
                </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">${{ number_format($payments->where('payment_status', 'completed')->sum('amount'), 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $payments->where('payment_status', 'pending')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $payments->where('payment_status', 'failed')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow rounded-lg">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $payment->subscription->transportContract->student->first_name ?? 'N/A' }} {{ $payment->subscription->transportContract->student->last_name ?? 'N/A' }}</div>
                                    <div class="text-sm text-gray-500">{{ $payment->subscription->transportContract->student->student_id ?? 'N/A' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $payment->subscription->pickupRoute->route_name ?? 'N/A' }}</div>
                                    <div class="text-sm text-gray-500">{{ $payment->subscription->pickupRoute->pickup_location ?? 'N/A' }} → {{ $payment->subscription->pickupRoute->dropoff_location ?? 'N/A' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('driver.payments.show', $payment) }}" class="text-blue-600 hover:text-blue-900">
                                            Ver Detalles
                                        </a>
                                    </div>
                                </td>
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">No tienes pagos registrados</h3>
                    <p class="mt-1 text-sm text-gray-500">Los pagos aparecerán aquí cuando se procesen.</p>
                </div>
            @endif
        </div>
    </div>
