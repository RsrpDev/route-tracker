...
@section('title', 'Estadísticas de Conductores - Escuela')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">📊 Estadísticas de Conductores</h1>
                <p class="mt-2 text-gray-600">Análisis detallado del servicio de transporte escolar</p>
            </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">Conductores con licencias que vencen en los próximos 30 días</p>
                    </div>
                </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-800">
                                    <strong>Acción requerida:</strong> Revisar y renovar las licencias próximas a vencer.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="text-center p-4 bg-yellow-50 rounded-lg">
                    ...
                    <div class="text-xs text-yellow-600 mt-1">Requieren atención</div>
                </div>
                <div class="text-center p-4 bg-red-50 rounded-lg">
                    ...
                    <div class="text-xs text-red-600 mt-1">Acción urgente</div>
                </div>
            </div>
        </div>
    </div>
