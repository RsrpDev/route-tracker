...
@section('title', 'Dashboard - Empresa de Transporte')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Empresa de Transporte</p>
    ...
    <!-- Gráfico de ingresos -->
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Ingresos de la Empresa - Últimos 6 Meses</h3>
    ...
    <!-- Acciones rápidas -->
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">⚡ Gestión Empresarial</h3>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{{ route('provider.drivers') }}" class="block p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors">
            ...
            <a href="{{ route('provider.routes') }}" class="block p-4 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-colors">
                <div class="text-center">
                    <div class="text-2xl mb-2">🚌</div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mt-8">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Resumen de Flota</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center">
                <div class="text-3xl font-bold text-blue-600">{{ number_format($activeDrivers) }}</div>
                <p class="text-sm text-gray-600">Conductores Activos</p>
            </div>
            <div class="text-center">
                <div class="text-3xl font-bold text-green-600">{{ number_format($activeVehicles) }}</div>
                <p class="text-sm text-gray-600">Vehículos Activos</p>
            </div>
            <div class="text-center">
                <div class="text-3xl font-bold text-purple-600">{{ number_format($activeRoutes) }}</div>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Dashboard de empresa de transporte cargado');
});
</script>
@endpush
@endsection
