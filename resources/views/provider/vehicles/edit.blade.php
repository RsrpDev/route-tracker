...
@section('title', 'Editar Vehículo - Conductor')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Editar Vehículo</h2>
                <p class="text-gray-600">{{ $vehicle->brand }} {{ $vehicle->model_year }} - {{ $vehicle->plate }}</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('driver.vehicles.show', $vehicle) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
    ...
    <form action="{{ route('driver.vehicles.update', $vehicle) }}" method="POST" class="space-y-8">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="plate" id="plate" value="{{ old('plate', $vehicle->plate) }}" required
                ...
                <div>
                    ...
                    <select name="fuel_type" id="fuel_type" required
                        ...
                        <option value="Gas Natural" {{ old('fuel_type', $vehicle->fuel_type) == 'Gas Natural' ? 'selected' : '' }}>Gas Natural</option>
                ...
                <div>
                    ...
                    <select name="vehicle_class" id="vehicle_class" required
                        ...
                        <option value="Automóvil" {{ old('vehicle_class', $vehicle->vehicle_class) == 'Automóvil' ? 'selected' : '' }}>Automóvil</option>
                        <option value="Camioneta" {{ old('vehicle_class', $vehicle->vehicle_class) == 'Camioneta' ? 'selected' : '' }}>Camioneta</option>
                        <option value="Bus" {{ old('vehicle_class', $vehicle->vehicle_class) == 'Bus' ? 'selected' : '' }}>Bus</option>
                        <option value="Microbús" {{ old('vehicle_class', $vehicle->vehicle_class) == 'Microbús' ? 'selected' : '' }}>Microbús</option>
                        <option value="Van" {{ old('vehicle_class', $vehicle->vehicle_class) == 'Van' ? 'selected' : '' }}>Van</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="capacity" id="capacity" value="{{ old('capacity', $vehicle->capacity) }}"
                ...
                <div>
                    ...
                    <select name="vehicle_status" id="vehicle_status" required
                        ...
                        <option value="active" {{ old('vehicle_status', $vehicle->vehicle_status) == 'active' ? 'selected' : '' }}>Activo</option>
                        <option value="inactive" {{ old('vehicle_status', $vehicle->vehicle_status) == 'inactive' ? 'selected' : '' }}>Inactivo</option>
                        <option value="maintenance" {{ old('vehicle_status', $vehicle->vehicle_status) == 'maintenance' ? 'selected' : '' }}>En Mantenimiento</option>
                        <option value="retired" {{ old('vehicle_status', $vehicle->vehicle_status) == 'retired' ? 'selected' : '' }}>Retirado</option>
                    </select>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="serial_number" id="serial_number" value="{{ old('serial_number', $vehicle->serial_number) }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div>
                    ...
                    <input type="number" name="cylinder_capacity" id="cylinder_capacity" value="{{ old('cylinder_capacity', $vehicle->cylinder_capacity) }}"
                           min="0"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div>
                    ...
                    <select name="service_type" id="service_type" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        <option value="">Seleccione un tipo</option>
                        <option value="Particular" {{ old('service_type', $vehicle->service_type) == 'Particular' ? 'selected' : '' }}>Particular</option>
                        <option value="Público" {{ old('service_type', $vehicle->service_type) == 'Público' ? 'selected' : '' }}>Público</option>
                        <option value="Escolar" {{ old('service_type', $vehicle->service_type) == 'Escolar' ? 'selected' : '' }}>Escolar</option>
                        <option value="Turismo" {{ old('service_type', $vehicle->service_type) == 'Turismo' ? 'selected' : '' }}>Turismo</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="odometer_reading" id="odometer_reading" value="{{ old('odometer_reading', $vehicle->odometer_reading) }}"
                           min="0"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="soat_number" id="soat_number" value="{{ old('soat_number', $vehicle->soat_number) }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div>
                    ...
                    <input type="date" name="soat_expiration" id="soat_expiration"
                           value="{{ old('soat_expiration', $vehicle->soat_expiration ? $vehicle->soat_expiration->format('Y-m-d') : '') }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div>
                    ...
                    <input type="text" name="insurance_company" id="insurance_company" value="{{ old('insurance_company', $vehicle->insurance_company) }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div>
                    ...
                    <input type="date" name="insurance_expiration" id="insurance_expiration"
                           value="{{ old('insurance_expiration', $vehicle->insurance_expiration ? $vehicle->insurance_expiration->format('Y-m-d') : '') }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div>
                    ...
                    <input type="date" name="technical_inspection_expiration" id="technical_inspection_expiration"
                           value="{{ old('technical_inspection_expiration', $vehicle->technical_inspection_expiration ? $vehicle->technical_inspection_expiration->format('Y-m-d') : '') }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div>
                    ...
                    <input type="date" name="revision_expiration" id="revision_expiration"
                           value="{{ old('revision_expiration', $vehicle->revision_expiration ? $vehicle->revision_expiration->format('Y-m-d') : '') }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="next_maintenance_date" id="next_maintenance_date"
                           value="{{ old('next_maintenance_date', $vehicle->next_maintenance_date ? $vehicle->next_maintenance_date->format('Y-m-d') : '') }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
        ...
        <div class="flex justify-end space-x-4">
            <a href="{{ route('driver.vehicles.show', $vehicle) }}"
