{{--
    Archivo: resources/views/provider/routes/create.blade.php
    Roles: provider
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                    <span class="text-sm font-medium text-gray-500">Crear Nueva Ruta</span>
                </div>
            </li>
        </ol>
    </nav>
...
@section('content')
    <div class="max-w-4xl mx-auto">
        <!-- Encabezado -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Crear Nueva Ruta</h1>
            <p class="mt-2 text-sm text-gray-600">Define una nueva ruta de transporte escolar para tu empresa</p>
        </div>

        <!-- Formulario -->
        <div class="bg-white shadow rounded-lg">
            <form method="POST" action="{{ route('provider.routes.store') }}" class="p-6 space-y-6">
                @csrf
